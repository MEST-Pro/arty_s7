...
#
# Generated by export_simulation on Wed Nov 15 19:28:34 -0800 2023
#
################################################################################
...
'-reset_run' switch to the './fpga_rom.sh' script.

./fpga_rom.sh -reset_run
...
./fpga_rom.sh -noclean_files

For more information on the script, please type './fpga_rom.sh -help'.
