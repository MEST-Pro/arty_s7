...
# Generated on: Sat Dec 23 14:28:34 EST 2023 (Sat Dec 23 19:28:34 UTC 2023)
...
set_log_file fv/asic_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/asic_top -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/data/cadence/GENUS20.11/tools.lnx86"
set CDN_SYNTH_ROOT      "/data/cadence/GENUS20.11/tools.lnx86"
set env(CW_DIR) "/data/cadence/GENUS20.11/tools.lnx86/lib/chipware"
set CW_DIR      "/data/cadence/GENUS20.11/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /home/elsadek.2/Share/DICD_course_130nm/techFiles -library -both
read_library -liberty -both /home/elsadek.2/Share/DICD_course_130nm/techFiles/sky130_fd_sc_hd__tt_025C_1v80.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden  -noelab -verilog2k -f  src_list
elaborate_design -golden -root {asic_top} -rootonly 

read_design -verilog95   -revised  -noelab fv/asic_top/fv_map.v.gz
elaborate_design -revised -root {asic_top}
...
#add_name_alias fv/asic_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box fpga_rom fpga_pll -golden
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/asic_top/rtl_to_fv_map.log
}
