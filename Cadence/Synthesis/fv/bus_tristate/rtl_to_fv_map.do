...
# Generated on: Sat Dec 23 14:14:16 EST 2023 (Sat Dec 23 19:14:16 UTC 2023)
...
set_log_file fv/bus_tristate/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/bus_tristate -revised fv_map
...
elaborate_design -golden -root {bus_tristate} -rootonly -rootonly  

read_design -verilog95   -revised  -noelab fv/bus_tristate/fv_map.v.gz
elaborate_design -revised -root {bus_tristate}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/bus_tristate/rtl_to_fv_map.log
}
